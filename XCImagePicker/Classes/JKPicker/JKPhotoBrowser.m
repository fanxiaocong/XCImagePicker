...
- (UIView *)topView{
    if (!_topView) {
        ...
        UIImage  *img = [JKUtil imageNamed:@"camera_edit_cut_cancel"];
        UIImage  *imgHigh = [JKUtil imageNamed:@"camera_edit_cut_cancel_highlighted"];
        ...
        UIImage *img1 = [UIImage imageNamed:@"input_check"];
        UIImage *imgH = [UIImage imageNamed:@"input_tick"];
